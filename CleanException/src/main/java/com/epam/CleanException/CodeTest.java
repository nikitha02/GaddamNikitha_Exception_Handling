package com.epam.CleanException;
...
public class CodeTest {
	...
	private static Logger LOGGER = LogManager.getLogger(CodeTest.class);

	public static void main(String[] args) {
		
		Scanner input = new Scanner(System.in);
		
		BudgetCalculator calculate = new BudgetCalculator();
		
		IntrestCalculation budget = new IntrestCalculation();
